...
$itemJson = Join-Path $pipelineRoot "intermediate\items-base.json"
$recipeCsv = Join-Path $pipelineRoot "input\Recipe.csv"
$outputJson = Join-Path $pipelineRoot "intermediate\items-with-recipes.json"
