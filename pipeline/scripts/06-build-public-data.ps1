...
$inputJson = Join-Path $pipelineRoot "intermediate\items-filtered.json"
$searchCatCsv = Join-Path $pipelineRoot "input\ItemSearchCategory.csv"
$outputJson = Join-Path $repositoryRoot "site\data\Item.json"
