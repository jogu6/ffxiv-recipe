...
$itemJson = Join-Path $pipelineRoot "intermediate\items-with-recipes.json"
$tokenCsv = Join-Path $pipelineRoot "input\token-items.csv"
$outputJson = Join-Path $pipelineRoot "intermediate\items-with-tokens.json"
